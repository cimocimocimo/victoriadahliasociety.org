...
class FOTY_Widget extends WP_Widget {
    ...
    function __construct() {
        $widget_ops = array(
            'classname' => 'foty_widget',
            'description' => 'Displays the Flowers Of The Year',
        );
        $control_ops = array(
            'width' => 250,
            'height' => 350,
        );
        parent::__construct( 'foty-widget', 'Flowers Of The Year Widget', $widget_ops, $control_ops );
    }
...
} // end class FOTY_Widget

function register_foty() {
  register_widget( 'FOTY_Widget' );
}
add_action( 'widgets_init', 'register_foty' );
