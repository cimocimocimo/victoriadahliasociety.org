...
function vds_gallery($content, $attr) {
	...
	extract(
	    shortcode_atts(
	        array(
        		...
        		'icontag'    => 'div',
        		'captiontag' => 'span',
// going to hard code the number of columns for the gallery
//        		'columns'    => 3,
        		'size'       => 'thumbnail',
        		'include'    => '',
        		'exclude'    => ''
...
add_filter('post_gallery', 'vds_gallery', 1, 2);
...
function is_last_post_on_page() {
    global $wp_query;
    
    if ( $wp_query->query_vars['posts_per_page'] == ($wp_query->current_post + 1) || $wp_query->post_count == ($wp_query->current_post + 1) )
        return true;
    else
        return false;
}
...
function twentyten_setup() {
	...
	register_nav_menus( array(
		...
		'foot-nav' => 'Footer Navigation Bar',
	) );
